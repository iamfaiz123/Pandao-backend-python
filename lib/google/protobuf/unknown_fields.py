...
if api_implementation._c_module is not None:  # pylint: disable=protected-access
  ...
  from email.protobuf.internal import decoder  # pylint: disable=g-import-not-at-top
  from email.protobuf.internal import wire_format  # pylint: disable=g-import-not-at-top
